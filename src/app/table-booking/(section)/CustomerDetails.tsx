  ...
  return (
    <div className="flex w-full flex-col items-end gap-5">
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  {...field}
                  className="h-12 border-muted bg-transparent text-[#9C9E9F]"
                />
              </FormControl>
              <FormMessage />
            </FormItem>
        ...
        render={({ field }) => (
          <FormItem className="w-full">
            ...
            <FormControl>
              <Textarea
                {...field}
                className="min-h-[100px] border-muted bg-transparent text-[#9C9E9F]"
      ...
      <div className="flex w-full justify-center">
        <Button
          type="submit"
          className="w-fit bg-[#33804D] px-6 py-6 text-[#9C9E9F] hover:bg-[#65da8c] md:float-right md:w-fit"
