...
const TimeForm: FC<TimeFormProps> = ({ mainform, setpage }) => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-3">
      <p className="text-3xl font-semibold text-[#DCCABC]">
      ...
      <Form {...form}>
        ...
        >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger className="h-12 border-muted bg-transparent text-[#9C9E9F]">
                  ...
                  <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                    <PopoverTrigger asChild>
                      <FormControl>
                        <Button
                          variant={"outline"}
                          className={`h-12 w-full justify-start border-muted bg-transparent text-left font-normal text-[#9C9E9F] hover:text-[#9C9E9F]`}
                        >
              ...
              <div className="custom-scrollbar grid h-[250px] grid-cols-2 gap-6 overflow-y-scroll md:grid-cols-4 lg:grid-cols-5">
                {generateTimeSlots().map((time) => (
                  <div
                    ...
                    className={cn(
                      "flex h-full w-full cursor-pointer items-center justify-center border-[1px] border-[#EBC488] py-4 text-[#9C9E9F]",
          ...
          <Button
            className="w-fit bg-[#33804D] px-6 py-6 text-[#000] hover:bg-[#65da8c]"
            disabled={disable}
          >
            Book A Table
          </Button>
