...
const BavetteStory = ({}) => {
  return (
    <section className="relative flex h-full w-full items-center justify-center bg-[#06130A] p-4 lg:py-16">
      <div className="flex h-full w-full flex-col items-center justify-center gap-11 bg-[#06130A]">
        <h2 className="font-oswald text-center text-8xl text-[#DCCABC] md:left-[15%] md:text-8xl">
          The Nova
          <br />
          Story
        </h2>
        <div className="flex h-full w-full flex-col items-center justify-center gap-4 bg-[#06130A] md:flex-row lg:px-24 lg:py-20">
          ...
          <div className="flex h-full w-full flex-col items-center gap-[2.5rem] p-6 md:w-1/2 md:items-start lg:ml-24">
            <h1 className="font-oswald max-w-[500px] text-center text-6xl text-[#DCCABC] sm:text-7xl md:text-start">
              From Passion
              <br />
              to Perfection{" "}
            </h1>
