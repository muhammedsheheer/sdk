...
const Contact = ({}) => {
  ...
  return (
    <section
      className="flex h-full w-full flex-col items-center justify-center bg-[#06130A]"
      id="contact"
    >
      <div className="flex h-full w-full max-w-[1300px] flex-col gap-[2.5rem] px-0 py-12 pl-0 md:px-2 md:py-24">
        <div className="flex w-full flex-col lg:flex-row">
          <div className="flex w-full flex-col gap-8 bg-[#06130A] px-6 lg:w-1/2 lg:px-28">
            <div className="flex flex-col gap-8">
              <p className="font-bai text-lg leading-[4px] text-[#DCCABC]">
                Contact Us
              </p>
              <h1 className="font-forum text-4xl font-medium uppercase leading-[50px] tracking-[5px] text-[#DCCABC] lg:text-5xl">
                Get in
                <br /> Touch
              </h1>
            </div>
          ...
          <div className="flex w-full flex-col bg-[#06130A] lg:w-1/2 lg:items-center lg:justify-center">
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="h-full">
                  ...
                  <div className="flex w-full flex-col pt-7 lg:flex-row">
                    <Button
                      className="font-bai w-full rounded-2xl bg-[#33804D] py-6 text-white placeholder:text-[#fff] hover:bg-[#65da8c]"
